<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolutionManager.aspx.cs"
    Inherits="Semitron_OMS.UI.Admin.Site.SolutionManager" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>网站后台系统 - 解决方案管理</title>
    <%--CSS Ref--%>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#FlexigridTable").flexigrid({
                ...
                url: '/Handle/Site/SolutionHandle.ashx', //数据请求地址
                dataType: 'json', //请求数据的格式
                extParam: [{ name: "meth", value: "GetSolution" }, { name: "TimeType", value: $("#sltTimeType").val() }, { name: "startTime", value: $("#txtBeginTime").val() }, { name: "AvailFlag", value: $("#sltAvailFlag").val()}], //扩展参数
            ...
            $("#btnEdit").click(function () {
                var obj = GetSelectedRow("FlexigridTable", "解决方案");
                if (!obj) {
                    return false;
                }
                if (obj[0][2] == "无效") {
                    artDialog.tips("当前解决方案记录已无效，无法完成此操作。");
                    return false;
                }
                var id = obj[0][1];
            ...
            $("#btnDelete").click(function () {
                ...
                if (obj[0][2] == "无效") {
                    artDialog.tips("当前解决方案已无效，请勿重复操作。");
                    return false;
                }
                var id = obj[0][1];
                DelSolution(id);
    ...
    <script type="text/javascript">
        ...
        function GetSolutionById(id) {
            var url = "/Handle/Site/SolutionHandle.ashx";
            var data = { "meth": "GetSolutionById", "Id": id };
            var successFun = function (json) {
                if (json.State == "0") {
                    ...
                    $("#txtareaDescription").text(json.Description);
        ...
        function AddOrEdit(id, type) {
            ...
            $.dialog({
                ...
                ok: function () {
                    ...
                    var Description = Trim($("#txtareaDescription").text());
                    ...
                    var url = "/Handle/Site/SolutionHandle.ashx";
                    //新增解决方案
                    var data = { "meth": "AddSolution", "Code": Code, "Name": Name, "SK": SK, "IsShowInMain": IsShowInMain, "Description": Description, "PageHeight": PageHeight, "Lang": Lang };
                    //编辑解决方案
                    if (id && id != "") {
                        data = { "meth": "EditSolution", "Code": Code, "Name": Name, "SK": SK, "IsShowInMain": IsShowInMain, "Description": Description, "PageHeight": PageHeight, "Lang": Lang, "Id": id };
                    }
                    var errorFun = function (x, e) {
                        alert(x.responseText);
                    };
        ...
        function DelSolution(id) {
            art.dialog.confirm('解决方案删除后将无法恢复，你确认要删除吗？', function () {
                //调用删除解决方案方法
                var url = "/Handle/Site/SolutionHandle.ashx";
                var data = { "meth": "DelSolution", "Id": id };
                var successFun = function (json) {
                    if (json.State == "0") {
                        artDialog.alert(json.Info);
                        return false;
    ...
    <script type="text/javascript">
        ...
        KindEditor.ready(function (K) {
            editor = K.create('#content1', {
                ...
                uploadJson: '/Handle/Site/UploadHandle.ashx?Type=solution',
                fileManagerJson: '/Handle/Site/FileManagerHandle.ashx?Type=solution',
            ...
            <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="trMO ">
                    ...
                    <td class="tdLeft tdRemarkWidth" colspan="3">
                        <textarea id="txtareaDescription" cols="51" rows="3"></textarea>
                    </td>
                    <td>
                    </td>
                </tr>
