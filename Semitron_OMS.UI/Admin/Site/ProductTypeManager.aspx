<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductTypeManager.aspx.cs"
    Inherits="Semitron_OMS.UI.Admin.Site.ProductTypeManager" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#FlexigridTable").flexigrid({
                ...
                url: '/Handle/Site/ProductTypeHandle.ashx', //数据请求地址
    ...
    <script type="text/javascript">
        ...
        function GetProductTypeById(id) {
            var url = "/Handle/Site/ProductTypeHandle.ashx";
