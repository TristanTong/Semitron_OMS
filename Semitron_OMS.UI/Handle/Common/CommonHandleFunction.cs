...
{
    public class CommonHandleFunction
    {
        /// <summary>
        /// 获取报表数据公用方法
        /// </summary>
        /// <param name="proName">存储过程名</param>
        /// <param name="strTableName">Excel表格名称</param>
        public static string GetReportCommon(string proName, string strTableName, AdminModel adminModel)
        {
            log4net.ILog myLogger = log4net.LogManager.GetLogger(typeof(CommonHandleFunction));//系统日志对象
