...
{
    /// <summary>
    /// 数据访问类:CurrencyTypeDAL
    /// </summary>
    public partial class CurrencyTypeDAL
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "CurrencyType");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from CurrencyType");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into CurrencyType(");
            strSql.Append("CurrencyName,ShortName,CountryName,SK,AvailFlag,CreateUser,CreateTime,UpdateUser,UpdateTime)");
            strSql.Append(" values (");
            strSql.Append("@CurrencyName,@ShortName,@CountryName,@SK,@AvailFlag,@CreateUser,@CreateTime,@UpdateUser,@UpdateTime)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@CurrencyName", SqlDbType.NVarChar,16),
					new SqlParameter("@ShortName", SqlDbType.VarChar,16),
					new SqlParameter("@CountryName", SqlDbType.NVarChar,16),
            ...
            parameters[0].Value = model.CurrencyName;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CurrencyType set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from CurrencyType ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        public Semitron_OMS.Model.OMS.CurrencyTypeModel GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,CurrencyName,ShortName,CountryName,SK,AvailFlag,CreateUser,CreateTime,UpdateUser,UpdateTime from CurrencyType ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            Semitron_OMS.Model.OMS.CurrencyTypeModel model = new Semitron_OMS.Model.OMS.CurrencyTypeModel();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Semitron_OMS.Model.OMS.CurrencyTypeModel DataRowToModel(DataRow row)
        {
            Semitron_OMS.Model.OMS.CurrencyTypeModel model = new Semitron_OMS.Model.OMS.CurrencyTypeModel();
            if (row != null)
            {
                ...
                if (row["CurrencyName"] != null)
                {
                    model.CurrencyName = row["CurrencyName"].ToString();
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,CurrencyName,ShortName,CountryName,SK,AvailFlag,CreateUser,CreateTime,UpdateUser,UpdateTime ");
            strSql.Append(" FROM CurrencyType ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,CurrencyName,ShortName,CountryName,SK,AvailFlag,CreateUser,CreateTime,UpdateUser,UpdateTime ");
            strSql.Append(" FROM CurrencyType ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from CurrencyType T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "CurrencyType";
        ...
        {
            //查询表名
            string strTableName = " CurrencyType ";
            //查询字段
            string strGetFields = " ID ,CurrencyName ,ShortName ,CountryName ,SK ,AvailFlag = CASE AvailFlag WHEN 1 THEN '有效' ELSE '无效' END , CreateUser , CreateTime = CONVERT(VARCHAR(20), CreateTime, 120) , UpdateUser , UpdateTime = CONVERT(VARCHAR(20), UpdateTime, 120) ";
            //查询条件
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CurrencyType set AvailFlag=" + iStatus);
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
