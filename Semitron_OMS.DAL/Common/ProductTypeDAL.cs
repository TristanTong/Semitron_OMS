...
namespace Semitron_OMS.DAL.Common
{
	...
	public partial class ProductTypeDAL
	{
		...
		public int Add(Semitron_OMS.Model.Common.ProductTypeModel model)
		{
			...
			strSql.Append("Code,TypeName,Pid,SK,AvailFlag,CreateUser,CreateTime,UpdateUser,UpdateTime,Lang)");
		...
		public Semitron_OMS.Model.Common.ProductTypeModel GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Code,TypeName,Pid,SK,AvailFlag,CreateUser,CreateTime,UpdateUser,UpdateTime,Lang from ProductType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			Semitron_OMS.Model.Common.ProductTypeModel model=new Semitron_OMS.Model.Common.ProductTypeModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public Semitron_OMS.Model.Common.ProductTypeModel DataRowToModel(DataRow row)
		{
			Semitron_OMS.Model.Common.ProductTypeModel model=new Semitron_OMS.Model.Common.ProductTypeModel();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Code,TypeName,Pid,SK,AvailFlag,CreateUser,CreateTime,UpdateUser,UpdateTime,Lang ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Code,TypeName,Pid,SK,AvailFlag,CreateUser,CreateTime,UpdateUser,UpdateTime,Lang ");
			strSql.Append(" FROM ProductType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
