/**  
* IndustryTrendModel.cs
*
* 功 能： N/A
* 类 名： IndustryTrendModel
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2013/6/30 18:19:18   童荣辉    初版
*
...
{
	/// <summary>
	/// IndustryTrendModel:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class IndustryTrendModel
	{
		public IndustryTrendModel()
		{}
        #region Model
        private int _id;
